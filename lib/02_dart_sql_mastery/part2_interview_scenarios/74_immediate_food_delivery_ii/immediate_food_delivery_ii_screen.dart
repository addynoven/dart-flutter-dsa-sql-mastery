...
import 'immediate_food_delivery_ii_widget.dart';

class ImmediateFoodDeliveryIi74Screen extends StatelessWidget {
  const ImmediateFoodDeliveryIi74Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #74: ImmediateFoodDeliveryIi',
      ...
      uiBuilder: (data, isCorrect) => ImmediateFoodDeliveryIi74Widget(records: data, isCorrect: isCorrect),
    );
  }
}
