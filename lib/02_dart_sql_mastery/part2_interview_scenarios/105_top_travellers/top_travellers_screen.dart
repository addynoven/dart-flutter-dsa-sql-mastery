...
import 'top_travellers_widget.dart';

class TopTravellers105Screen extends StatelessWidget {
  const TopTravellers105Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #105: TopTravellers',
      ...
      uiBuilder: (data, isCorrect) => TopTravellers105Widget(records: data, isCorrect: isCorrect),
    );
  }
}
