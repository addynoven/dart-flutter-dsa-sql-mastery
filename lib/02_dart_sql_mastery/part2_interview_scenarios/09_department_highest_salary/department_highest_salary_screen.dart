...
import 'department_highest_salary_widget.dart';

class DepartmentHighestSalary09Screen extends StatelessWidget {
  const DepartmentHighestSalary09Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #09: DepartmentHighestSalary',
      ...
      uiBuilder: (data, isCorrect) => DepartmentHighestSalary09Widget(records: data, isCorrect: isCorrect),
    );
  }
}
