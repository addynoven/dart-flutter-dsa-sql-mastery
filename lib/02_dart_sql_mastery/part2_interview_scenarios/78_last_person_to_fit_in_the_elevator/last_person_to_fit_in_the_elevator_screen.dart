...
import 'last_person_to_fit_in_the_elevator_widget.dart';

class LastPersonToFitInTheElevator78Screen extends StatelessWidget {
  const LastPersonToFitInTheElevator78Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #78: LastPersonToFitInTheElevator',
      ...
      uiBuilder: (data, isCorrect) => LastPersonToFitInTheElevator78Widget(records: data, isCorrect: isCorrect),
    );
  }
}
