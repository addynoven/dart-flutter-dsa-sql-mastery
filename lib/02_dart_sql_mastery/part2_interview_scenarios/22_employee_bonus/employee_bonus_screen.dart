...
import 'employee_bonus_widget.dart';

class EmployeeBonus22Screen extends StatelessWidget {
  const EmployeeBonus22Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #22: EmployeeBonus',
      ...
      uiBuilder: (data, isCorrect) => EmployeeBonus22Widget(records: data, isCorrect: isCorrect),
    );
  }
}
