...
import 'trips_and_users_widget.dart';

class TripsAndUsers13Screen extends StatelessWidget {
  const TripsAndUsers13Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #13: TripsAndUsers',
      ...
      uiBuilder: (data, isCorrect) => TripsAndUsers13Widget(records: data, isCorrect: isCorrect),
    );
  }
}
