...
import 'students_and_examinations_widget.dart';

class StudentsAndExaminations87Screen extends StatelessWidget {
  const StudentsAndExaminations87Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #87: StudentsAndExaminations',
      ...
      uiBuilder: (data, isCorrect) => StudentsAndExaminations87Widget(records: data, isCorrect: isCorrect),
    );
  }
}
