...
import 'monthly_transactions_ii_widget.dart';

class MonthlyTransactionsIi79Screen extends StatelessWidget {
  const MonthlyTransactionsIi79Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #79: MonthlyTransactionsIi',
      ...
      uiBuilder: (data, isCorrect) => MonthlyTransactionsIi79Widget(records: data, isCorrect: isCorrect),
    );
  }
}
