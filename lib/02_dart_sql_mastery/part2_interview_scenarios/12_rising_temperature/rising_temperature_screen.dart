...
import 'rising_temperature_widget.dart';

class RisingTemperature12Screen extends StatelessWidget {
  const RisingTemperature12Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #12: RisingTemperature',
      ...
      uiBuilder: (data, isCorrect) => RisingTemperature12Widget(records: data, isCorrect: isCorrect),
    );
  }
}
