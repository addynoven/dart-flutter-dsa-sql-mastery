...
import 'list_the_products_ordered_in_a_period_widget.dart';

class ListTheProductsOrderedInAPeriod94Screen extends StatelessWidget {
  const ListTheProductsOrderedInAPeriod94Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #94: ListTheProductsOrderedInAPeriod',
      ...
      uiBuilder: (data, isCorrect) => ListTheProductsOrderedInAPeriod94Widget(records: data, isCorrect: isCorrect),
    );
  }
}
