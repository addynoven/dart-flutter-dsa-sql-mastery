...
import 'consecutive_numbers_widget.dart';

class ConsecutiveNumbers05Screen extends StatelessWidget {
  const ConsecutiveNumbers05Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #05: ConsecutiveNumbers',
      ...
      uiBuilder: (data, isCorrect) => ConsecutiveNumbers05Widget(records: data, isCorrect: isCorrect),
    );
  }
}
