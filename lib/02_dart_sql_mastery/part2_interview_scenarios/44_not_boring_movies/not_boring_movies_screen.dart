...
import 'not_boring_movies_widget.dart';

class NotBoringMovies44Screen extends StatelessWidget {
  const NotBoringMovies44Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #44: NotBoringMovies',
      ...
      uiBuilder: (data, isCorrect) => NotBoringMovies44Widget(records: data, isCorrect: isCorrect),
    );
  }
}
