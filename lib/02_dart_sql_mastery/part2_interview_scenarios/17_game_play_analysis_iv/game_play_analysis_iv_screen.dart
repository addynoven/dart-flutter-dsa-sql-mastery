...
import 'game_play_analysis_iv_widget.dart';

class GamePlayAnalysisIv17Screen extends StatelessWidget {
  const GamePlayAnalysisIv17Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #17: GamePlayAnalysisIv',
      ...
      uiBuilder: (data, isCorrect) => GamePlayAnalysisIv17Widget(records: data, isCorrect: isCorrect),
    );
  }
}
