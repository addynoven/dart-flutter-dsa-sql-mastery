...
import 'swap_salary_widget.dart';

class SwapSalary46Screen extends StatelessWidget {
  const SwapSalary46Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #46: SwapSalary',
      ...
      uiBuilder: (data, isCorrect) => SwapSalary46Widget(records: data, isCorrect: isCorrect),
    );
  }
}
