...
import 'reported_posts_widget.dart';

class ReportedPosts62Screen extends StatelessWidget {
  const ReportedPosts62Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #62: ReportedPosts',
      ...
      uiBuilder: (data, isCorrect) => ReportedPosts62Widget(records: data, isCorrect: isCorrect),
    );
  }
}
