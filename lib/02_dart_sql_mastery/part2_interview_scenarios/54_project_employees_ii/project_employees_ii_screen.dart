...
class ProjectEmployeesIi54Screen extends StatelessWidget {
  const ProjectEmployeesIi54Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #54: ProjectEmployeesIi',
      ...
      uiBuilder: (data, isCorrect) => ProjectEmployeesIi54Widget(records: data, isCorrect: isCorrect),
    );
  }
}
