...
import 'students_report_by_geography_widget.dart';

class StudentsReportByGeography42Screen extends StatelessWidget {
  const StudentsReportByGeography42Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #42: StudentsReportByGeography',
      ...
      uiBuilder: (data, isCorrect) => StudentsReportByGeography42Widget(records: data, isCorrect: isCorrect),
    );
  }
}
