...
import 'page_recommendations_widget.dart';

class PageRecommendations85Screen extends StatelessWidget {
  const PageRecommendations85Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #85: PageRecommendations',
      ...
      uiBuilder: (data, isCorrect) => PageRecommendations85Widget(records: data, isCorrect: isCorrect),
    );
  }
}
