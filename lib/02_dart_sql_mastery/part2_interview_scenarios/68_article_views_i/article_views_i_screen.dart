...
import 'article_views_i_widget.dart';

class ArticleViewsI68Screen extends StatelessWidget {
  const ArticleViewsI68Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #68: ArticleViewsI',
      ...
      uiBuilder: (data, isCorrect) => ArticleViewsI68Widget(records: data, isCorrect: isCorrect),
    );
  }
}
