...
import 'reported_posts_ii_widget.dart';

class ReportedPostsIi65Screen extends StatelessWidget {
  const ReportedPostsIi65Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #65: ReportedPostsIi',
      ...
      uiBuilder: (data, isCorrect) => ReportedPostsIi65Widget(records: data, isCorrect: isCorrect),
    );
  }
}
