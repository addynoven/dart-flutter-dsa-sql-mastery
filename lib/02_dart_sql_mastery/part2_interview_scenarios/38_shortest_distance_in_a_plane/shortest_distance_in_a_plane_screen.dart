...
import 'shortest_distance_in_a_plane_widget.dart';

class ShortestDistanceInAPlane38Screen extends StatelessWidget {
  const ShortestDistanceInAPlane38Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #38: ShortestDistanceInAPlane',
      ...
      uiBuilder: (data, isCorrect) => ShortestDistanceInAPlane38Widget(records: data, isCorrect: isCorrect),
    );
  }
}
