...
class MovieRating96Screen extends StatelessWidget {
  const MovieRating96Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #96: MovieRating',
      ...
      uiBuilder: (data, isCorrect) => MovieRating96Widget(records: data, isCorrect: isCorrect),
    );
  }
}
