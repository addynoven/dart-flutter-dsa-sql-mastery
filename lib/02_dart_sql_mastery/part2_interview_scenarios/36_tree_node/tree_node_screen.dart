...
class TreeNode36Screen extends StatelessWidget {
  const TreeNode36Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #36: TreeNode',
      ...
      uiBuilder: (data, isCorrect) => TreeNode36Widget(records: data, isCorrect: isCorrect),
    );
  }
}
