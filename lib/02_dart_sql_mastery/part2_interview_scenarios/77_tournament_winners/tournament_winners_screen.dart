...
import 'tournament_winners_widget.dart';

class TournamentWinners77Screen extends StatelessWidget {
  const TournamentWinners77Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #77: TournamentWinners',
      ...
      uiBuilder: (data, isCorrect) => TournamentWinners77Widget(records: data, isCorrect: isCorrect),
    );
  }
}
