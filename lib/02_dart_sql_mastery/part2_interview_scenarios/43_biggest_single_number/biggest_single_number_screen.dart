...
import 'biggest_single_number_widget.dart';

class BiggestSingleNumber43Screen extends StatelessWidget {
  const BiggestSingleNumber43Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #43: BiggestSingleNumber',
      ...
      uiBuilder: (data, isCorrect) => BiggestSingleNumber43Widget(records: data, isCorrect: isCorrect),
    );
  }
}
