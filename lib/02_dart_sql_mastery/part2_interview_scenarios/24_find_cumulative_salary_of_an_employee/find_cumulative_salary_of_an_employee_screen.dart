...
import 'find_cumulative_salary_of_an_employee_widget.dart';

class FindCumulativeSalaryOfAnEmployee24Screen extends StatelessWidget {
  const FindCumulativeSalaryOfAnEmployee24Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #24: FindCumulativeSalaryOfAnEmployee',
      ...
      uiBuilder: (data, isCorrect) => FindCumulativeSalaryOfAnEmployee24Widget(records: data, isCorrect: isCorrect),
    );
  }
}
