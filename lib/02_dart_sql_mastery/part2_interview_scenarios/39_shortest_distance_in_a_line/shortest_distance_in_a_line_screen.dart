...
import 'shortest_distance_in_a_line_widget.dart';

class ShortestDistanceInALine39Screen extends StatelessWidget {
  const ShortestDistanceInALine39Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #39: ShortestDistanceInALine',
      ...
      uiBuilder: (data, isCorrect) => ShortestDistanceInALine39Widget(records: data, isCorrect: isCorrect),
    );
  }
}
