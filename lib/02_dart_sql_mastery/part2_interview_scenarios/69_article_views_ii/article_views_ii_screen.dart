...
import 'article_views_ii_widget.dart';

class ArticleViewsIi69Screen extends StatelessWidget {
  const ArticleViewsIi69Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #69: ArticleViewsIi',
      ...
      uiBuilder: (data, isCorrect) => ArticleViewsIi69Widget(records: data, isCorrect: isCorrect),
    );
  }
}
