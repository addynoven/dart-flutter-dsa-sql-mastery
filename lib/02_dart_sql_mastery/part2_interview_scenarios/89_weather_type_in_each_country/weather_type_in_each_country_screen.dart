...
import 'weather_type_in_each_country_widget.dart';

class WeatherTypeInEachCountry89Screen extends StatelessWidget {
  const WeatherTypeInEachCountry89Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #89: WeatherTypeInEachCountry',
      ...
      uiBuilder: (data, isCorrect) => WeatherTypeInEachCountry89Widget(records: data, isCorrect: isCorrect),
    );
  }
}
