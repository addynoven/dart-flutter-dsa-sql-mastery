...
import 'friend_requests_ii_who_has_the_most_friends_widget.dart';

class FriendRequestsIiWhoHasTheMostFriends33Screen extends StatelessWidget {
  const FriendRequestsIiWhoHasTheMostFriends33Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #33: FriendRequestsIiWhoHasTheMostFriends',
      ...
      uiBuilder: (data, isCorrect) => FriendRequestsIiWhoHasTheMostFriends33Widget(records: data, isCorrect: isCorrect),
    );
  }
}
