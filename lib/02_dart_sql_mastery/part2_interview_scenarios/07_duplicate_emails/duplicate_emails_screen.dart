...
import 'duplicate_emails_widget.dart';

class DuplicateEmails07Screen extends StatelessWidget {
  const DuplicateEmails07Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #07: DuplicateEmails',
      ...
      uiBuilder: (data, isCorrect) => DuplicateEmails07Widget(records: data, isCorrect: isCorrect),
    );
  }
}
