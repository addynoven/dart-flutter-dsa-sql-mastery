...
import 'reformat_department_table_widget.dart';

class ReformatDepartmentTable75Screen extends StatelessWidget {
  const ReformatDepartmentTable75Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #75: ReformatDepartmentTable',
      ...
      uiBuilder: (data, isCorrect) => ReformatDepartmentTable75Widget(records: data, isCorrect: isCorrect),
    );
  }
}
