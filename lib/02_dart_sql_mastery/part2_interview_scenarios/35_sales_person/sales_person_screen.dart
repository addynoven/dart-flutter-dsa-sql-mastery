...
import 'sales_person_widget.dart';

class SalesPerson35Screen extends StatelessWidget {
  const SalesPerson35Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #35: SalesPerson',
      ...
      uiBuilder: (data, isCorrect) => SalesPerson35Widget(records: data, isCorrect: isCorrect),
    );
  }
}
