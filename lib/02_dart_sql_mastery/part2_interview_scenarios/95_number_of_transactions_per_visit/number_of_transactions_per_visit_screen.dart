...
import 'number_of_transactions_per_visit_widget.dart';

class NumberOfTransactionsPerVisit95Screen extends StatelessWidget {
  const NumberOfTransactionsPerVisit95Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #95: NumberOfTransactionsPerVisit',
      ...
      uiBuilder: (data, isCorrect) => NumberOfTransactionsPerVisit95Widget(records: data, isCorrect: isCorrect),
    );
  }
}
