...
class SalesAnalysisI56Screen extends StatelessWidget {
  const SalesAnalysisI56Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #56: SalesAnalysisI',
      ...
      uiBuilder: (data, isCorrect) => SalesAnalysisI56Widget(records: data, isCorrect: isCorrect),
    );
  }
}
