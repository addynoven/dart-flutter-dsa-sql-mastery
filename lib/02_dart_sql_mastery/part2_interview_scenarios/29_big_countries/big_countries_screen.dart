...
import 'big_countries_widget.dart';

class BigCountries29Screen extends StatelessWidget {
  const BigCountries29Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #29: BigCountries',
      ...
      uiBuilder: (data, isCorrect) => BigCountries29Widget(records: data, isCorrect: isCorrect),
    );
  }
}
