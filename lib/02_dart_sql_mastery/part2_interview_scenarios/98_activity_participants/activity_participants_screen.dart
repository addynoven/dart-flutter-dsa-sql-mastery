...
import 'activity_participants_widget.dart';

class ActivityParticipants98Screen extends StatelessWidget {
  const ActivityParticipants98Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #98: ActivityParticipants',
      ...
      uiBuilder: (data, isCorrect) => ActivityParticipants98Widget(records: data, isCorrect: isCorrect),
    );
  }
}
