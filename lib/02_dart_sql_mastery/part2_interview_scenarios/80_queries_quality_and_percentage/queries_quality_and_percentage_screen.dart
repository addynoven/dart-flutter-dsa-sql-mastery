...
import 'queries_quality_and_percentage_widget.dart';

class QueriesQualityAndPercentage80Screen extends StatelessWidget {
  const QueriesQualityAndPercentage80Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #80: QueriesQualityAndPercentage',
      ...
      uiBuilder: (data, isCorrect) => QueriesQualityAndPercentage80Widget(records: data, isCorrect: isCorrect),
    );
  }
}
