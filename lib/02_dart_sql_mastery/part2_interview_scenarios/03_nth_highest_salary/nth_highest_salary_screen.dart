...
import 'nth_highest_salary_widget.dart';

class NthHighestSalary03Screen extends StatelessWidget {
  const NthHighestSalary03Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #03: NthHighestSalary',
      ...
      uiBuilder: (data, isCorrect) => NthHighestSalary03Widget(records: data, isCorrect: isCorrect),
    );
  }
}
