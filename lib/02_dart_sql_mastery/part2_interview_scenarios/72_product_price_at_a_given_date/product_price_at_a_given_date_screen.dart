...
import 'product_price_at_a_given_date_widget.dart';

class ProductPriceAtAGivenDate72Screen extends StatelessWidget {
  const ProductPriceAtAGivenDate72Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #72: ProductPriceAtAGivenDate',
      ...
      uiBuilder: (data, isCorrect) => ProductPriceAtAGivenDate72Widget(records: data, isCorrect: isCorrect),
    );
  }
}
