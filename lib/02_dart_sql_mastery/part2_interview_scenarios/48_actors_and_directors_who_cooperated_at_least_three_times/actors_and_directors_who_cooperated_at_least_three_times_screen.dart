...
import 'actors_and_directors_who_cooperated_at_least_three_times_widget.dart';

class ActorsAndDirectorsWhoCooperatedAtLeastThreeTimes48Screen extends StatelessWidget {
  const ActorsAndDirectorsWhoCooperatedAtLeastThreeTimes48Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #48: ActorsAndDirectorsWhoCooperatedAtLeastThreeTimes',
      ...
      uiBuilder: (data, isCorrect) => ActorsAndDirectorsWhoCooperatedAtLeastThreeTimes48Widget(records: data, isCorrect: isCorrect),
    );
  }
}
