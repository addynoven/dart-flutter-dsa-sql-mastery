...
import 'customers_who_bought_products_a_and_b_but_not_c_widget.dart';

class CustomersWhoBoughtProductsAAndBButNotC104Screen extends StatelessWidget {
  const CustomersWhoBoughtProductsAAndBButNotC104Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #104: CustomersWhoBoughtProductsAAndBButNotC',
      ...
      uiBuilder: (data, isCorrect) => CustomersWhoBoughtProductsAAndBButNotC104Widget(records: data, isCorrect: isCorrect),
    );
  }
}
