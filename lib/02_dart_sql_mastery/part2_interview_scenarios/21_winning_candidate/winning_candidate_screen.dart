...
import 'winning_candidate_widget.dart';

class WinningCandidate21Screen extends StatelessWidget {
  const WinningCandidate21Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #21: WinningCandidate',
      ...
      uiBuilder: (data, isCorrect) => WinningCandidate21Widget(records: data, isCorrect: isCorrect),
    );
  }
}
