...
import 'ads_performance_widget.dart';

class AdsPerformance93Screen extends StatelessWidget {
  const AdsPerformance93Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return SqlUiInteractiveContainer(
      scenarioTitle: 'SQL Question #93: AdsPerformance',
      ...
      uiBuilder: (data, isCorrect) => AdsPerformance93Widget(records: data, isCorrect: isCorrect),
    );
  }
}
